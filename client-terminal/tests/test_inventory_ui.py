...
class TestInventoryUIInit:
    ...
    def test_init_creates_default_loader(self, mock_character):
        ...
        with patch("terminal_client.ui.inventory_ui.DataLoader") as mock_loader_class:
...
class TestCharacterSelection:
    ...
    @patch("terminal_client.ui.inventory_ui.questionary")
...
class TestEquipmentManagement:
    ...
    @patch("terminal_client.ui.inventory_ui.questionary")
    @patch("terminal_client.ui.inventory_ui.print_status_message")
