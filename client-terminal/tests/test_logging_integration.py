...
from terminal_client.ui.rich_ui import console, init_console
...
class TestDebugModeIntegration:
    ...
    def test_console_output_to_file(self, tmp_path):
        ...
        try:
            ...
            from terminal_client.ui.rich_ui import console, print_message
    ...
    def test_log_file_encoding(self, tmp_path):
        ...
        try:
            ...
            from terminal_client.ui.rich_ui import print_message
    ...
    def test_no_log_file_created_without_debug(self, tmp_path):
        ...
        try:
            ...
            if logs_dir.exists():
                ...
                list(logs_dir.glob("dnd_game_*.log"))
