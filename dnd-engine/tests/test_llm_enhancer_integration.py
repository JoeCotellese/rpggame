...
class TestLLMEnhancer:
    ...
    async def test_enhancer_subscribes_to_events(self) -> None:
        ...
        event_bus = EventBus()
        LLMEnhancer(mock_provider, event_bus)
    ...
    async def test_enhancer_caching(self) -> None:
        ...
        event_bus = EventBus()
        LLMEnhancer(mock_provider, event_bus, enable_cache=True)
    ...
    async def test_enhancer_no_caching(self) -> None:
        ...
        event_bus = EventBus()
        LLMEnhancer(mock_provider, event_bus, enable_cache=False)
