...
class TestResourcePoolBasics:
    ...
    def test_resource_pool_creation(self):
        ...
        pool = ResourcePool(name="action_surge", current=1, maximum=1, recovery_type="short_rest")
    ...
    def test_resource_pool_with_different_current_and_max(self):
        ...
        pool = ResourcePool(name="ki_points", current=2, maximum=5, recovery_type="long_rest")
...
class TestResourcePoolUsage:
    ...
    def test_use_single_resource(self):
        ...
        pool = ResourcePool(name="spell_slots", current=2, maximum=2, recovery_type="long_rest")
    ...
    def test_use_exact_remaining(self):
        ...
        pool = ResourcePool(name="resources", current=3, maximum=5, recovery_type="daily")
        assert pool.use(3) is True
    ...
    def test_use_insufficient_resources_returns_false(self):
        ...
        pool = ResourcePool(name="resources", current=2, maximum=5, recovery_type="short_rest")
    ...
    def test_use_from_empty_pool(self):
        ...
        pool = ResourcePool(name="empty_pool", current=0, maximum=3, recovery_type="short_rest")
        assert pool.use() is False
        assert pool.current == 0

    def test_use_zero_amount(self):
        """Test using zero resources"""
        pool = ResourcePool(name="resources", current=5, maximum=5, recovery_type="short_rest")
...
class TestResourcePoolRecovery:
    ...
    def test_recover_all_resources(self):
        ...
        pool = ResourcePool(name="action_surge", current=0, maximum=1, recovery_type="short_rest")
    ...
    def test_recover_more_than_max(self):
        ...
        pool = ResourcePool(name="resources", current=1, maximum=5, recovery_type="long_rest")
    ...
    def test_recover_all_from_depleted(self):
        ...
        pool = ResourcePool(name="spell_slots", current=0, maximum=3, recovery_type="long_rest")
    ...
    def test_recover_partial_from_depleted(self):
        ...
        pool = ResourcePool(name="resources", current=0, maximum=5, recovery_type="short_rest")
...
class TestResourcePoolStateChecking:
    ...
    def test_is_available_sufficient_resources(self):
        ...
        pool = ResourcePool(name="action_surge", current=2, maximum=2, recovery_type="short_rest")
    ...
    def test_is_available_insufficient_resources(self):
        ...
        pool = ResourcePool(name="resources", current=1, maximum=3, recovery_type="short_rest")
        assert pool.is_available(2) is False

    def test_is_available_default_amount(self):
        """Test is_available with default amount (1)"""
        pool = ResourcePool(name="resources", current=1, maximum=1, recovery_type="short_rest")
...
class TestResourcePoolBoundaryConditions:
    ...
    def test_zero_maximum_pool(self):
        ...
        pool = ResourcePool(name="zero_pool", current=0, maximum=0, recovery_type="permanent")
        assert pool.is_empty() is True
        assert pool.is_full() is True
        assert pool.use() is False
    ...
    def test_large_resource_values(self):
        ...
        pool = ResourcePool(
            name="large_pool", current=1000, maximum=1000, recovery_type="permanent"
        )
...
class TestResourcePoolDifferentRecoveryTypes:
    ...
    def test_long_rest_recovery_type(self):
        ...
        pool = ResourcePool(name="spell_slots", current=0, maximum=2, recovery_type="long_rest")
        assert pool.recovery_type == "long_rest"

    def test_daily_recovery_type(self):
        """Test daily recovery type"""
        pool = ResourcePool(name="daily_ability", current=0, maximum=3, recovery_type="daily")
        assert pool.recovery_type == "daily"

    def test_permanent_recovery_type(self):
        """Test permanent recovery type (never recovers)"""
        pool = ResourcePool(
            name="permanent_resource", current=5, maximum=5, recovery_type="permanent"
        )
