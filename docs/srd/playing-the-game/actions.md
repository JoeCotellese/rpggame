...
When you do something other than moving or communicating, you typically take an action. The Action
table lists the game’s main actions, which are defined in more detail in “Rules Glossary.”
...
For the rest of the turn, give yourself extra
...
Help another creature’s ability check or
...
Make a Charisma (Deception, Intimidation,
...
Prepare to take an action in response to a
trigger you define.

Search

Make a Wisdom (Insight, Medicine,
...
and other abilities provide additional action options, and you can improvise other actions. When
...
social interaction, you can try to Influence a creature or use the Search action to read the creature’s
