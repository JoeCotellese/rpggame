...
source_lines: 2228-2246
source_pages: 16
srd_chapter: playing-the-game
srd_section: Saving Throws and Damage
license: CC-BY-4.0
---
...
the same time, roll the damage once for all the targets. For example, when a wizard casts Fireball, the
