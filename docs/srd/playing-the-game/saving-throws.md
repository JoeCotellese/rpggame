...
source_lines: 866-946
source_pages: 7
srd_chapter: playing-the-game
srd_section: Saving Throws
license: CC-BY-4.0
---
...
make a save; you must make one because your character or a monster (if you’re the GM) is at risk. A
...
Melee attack with a weapon or an Unarmed Strike (see “Rules Glossary”)
...
Spell attack (the ability used is determined
...
The Difficulty Class for a saving throw is determined by the effect that causes it or by the GM. For
