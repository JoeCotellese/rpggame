...
source_lines: 1537-1578
source_pages: 11
srd_chapter: playing-the-game
srd_section: Vision and Light
license: CC-BY-4.0
---
...
You have the Blinded condition (see “Rules Glossary”) when trying to see something there.
...
do torches, lanterns, fires, and other sources of illumination within a specific radius.
Dim Light. Dim Light, also called shadows, creates a Lightly Obscured area. An area of Dim Light
