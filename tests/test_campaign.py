...
class TestCampaign:
    ...
    def test_create_campaign(self):
        ...
        now = datetime.now()
        campaign = Campaign(name="Test Campaign", created_at=now, last_played=now)
    ...
    def test_get_playtime_display_seconds(self):
        ...
        campaign = Campaign(
            name="Test", created_at=datetime.now(), last_played=datetime.now(), playtime_seconds=45
        )
    ...
    def test_get_last_played_display_just_now(self):
        ...
        campaign = Campaign(name="Test", created_at=datetime.now(), last_played=datetime.now())
    ...
    def test_get_last_played_display_hours(self):
        ...
        campaign = Campaign(
            name="Test", created_at=datetime.now(), last_played=datetime.now() - timedelta(hours=3)
        )
    ...
    def test_get_last_played_display_one_hour(self):
        ...
        campaign = Campaign(
            name="Test", created_at=datetime.now(), last_played=datetime.now() - timedelta(hours=1)
        )
    ...
    def test_get_last_played_display_days(self):
        ...
        campaign = Campaign(
            name="Test", created_at=datetime.now(), last_played=datetime.now() - timedelta(days=5)
        )
    ...
    def test_get_last_played_display_one_day(self):
        ...
        campaign = Campaign(
            name="Test", created_at=datetime.now(), last_played=datetime.now() - timedelta(days=1)
        )
...
class TestSaveSlotMetadata:
    ...
    def test_create_save_slot_metadata_minimal(self):
        ...
        now = datetime.now()
        slot = SaveSlotMetadata(slot_name="test_save", created_at=now)
    ...
    def test_get_time_display_old_date(self):
        ...
        slot = SaveSlotMetadata(slot_name="test", created_at=old_date)
